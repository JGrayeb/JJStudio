...
export const metadata = {
  ...
  openGraph: { title: "Tu primera clase Lagree | JJ Studio", description: "Todo lo que necesitas saber antes de subirte al Megaformer por primera vez.", url: "/primera-clase-lagree", images: [{ url: "/images/Coach Dani.JPG", alt: "Coach de JJ Studio acompañando una clase Lagree" }] },
  twitter: { card: "summary_large_image", images: ["/images/Coach Dani.JPG"] },
}
